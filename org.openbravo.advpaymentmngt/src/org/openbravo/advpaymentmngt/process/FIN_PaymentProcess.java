...
public class FIN_PaymentProcess implements org.openbravo.scheduling.Process {
  ...
  protected void processPayment(FIN_Payment payment, String strAction, String paymentDate,
  ...
  public String createDebitNote(String paymentDetailId) {
    String result = null;
    ConnectionProvider conn = new DalConnectionProvider(false);
    try {
      String sql = "SELECT ssdnid_createdebitnote(?) AS result";
      PreparedStatement st = null;
      st = conn.getPreparedStatement(sql);
      st.setString(1, paymentDetailId);
